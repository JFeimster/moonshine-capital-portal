    ...
    <div className="bg-neo-white min-h-screen text-neo-black">
      ...
      <div className="bg-neo-black text-neo-white py-12 px-4 md:px-6 lg:px-8 border-b-4 border-neo-green">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-black uppercase tracking-tighter mb-3">Partner Directory</h1>
          <p className="text-lg md:text-xl font-medium text-neo-cream/90 max-w-2xl">
      ...
      {brokers.length === 0 ? (
        <div className="py-14 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="bg-neo-cream border-4 border-neo-black p-8 text-center shadow-brutal">
