    ...
    <main className="min-h-screen bg-neo-white text-neo-black">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12 md:px-12 md:py-16">
        ...
        <div className="border-4 border-neo-black bg-neo-yellow p-6 shadow-brutal">
          <div className="text-xs font-black uppercase tracking-[0.2em] text-neo-black/70">{resource.category}</div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          {resource.ctaHref ? <a href={resource.ctaHref} className="btn-brutal">Open resource</a> : <Link href={`/${broker.slug}/resources`} className="btn-brutal">Back to resources</Link>}
        </div>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="border-4 border-neo-black bg-neo-cream p-6 shadow-brutal">
            ...
            <p className="mt-4 text-base font-medium leading-relaxed">This resource is designed to reduce confusion and support the business owner in preparing for a stronger, more practical funding conversation.</p>
          </div>
