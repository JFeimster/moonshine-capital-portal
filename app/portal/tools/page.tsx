      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="border-4 border-neo-black bg-neo-white p-6 shadow-[12px_12px_0_0_rgba(0,0,0,1)]">
          ...
          <p className="mt-3 max-w-3xl text-base font-medium leading-relaxed text-neo-black/80">
            This section should become the broker utility layer: calculators, widgets, GPTs, lead tools, and app links that help operators actually move money.
          </p>
        </section>
        <ToolGrid tools={tools} emptyTitle="No portal tools active" emptyMessage="Load real Vercel apps, calculators, and GPT assets into the embed registry so this page earns its existence." />
      </div>
    </main>
  );
}
