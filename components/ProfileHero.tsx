  ...
  return (
    <div className="bg-neo-black text-neo-white p-8 md:p-16 border-4 border-neo-orange relative overflow-hidden shadow-brutal mb-12">
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
        <div className="w-32 h-32 md:w-48 md:h-48 bg-neo-cream border-4 border-neo-white shadow-brutal-white flex-shrink-0">
          {broker.profileImage ? (
            <img src={broker.profileImage} alt={broker.fullName} className="w-full h-full object-cover" />
          ) : (
             <div className="w-full h-full flex items-center justify-center text-neo-black font-black text-5xl">
